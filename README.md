...
*   **Current**: 1.1 (32-bit & 64-bit x86 Support, Linux 6.14 Kernel, JurkStore TUI, BusyBox integration).
...
3.  To test in QEMU on Windows using Physical Drive 1:
    ```cmd
    ...
    ```
4.  Enjoy a raw, powerful interface that puts you back in control.
